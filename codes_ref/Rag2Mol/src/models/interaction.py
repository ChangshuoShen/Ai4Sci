...
class CFTransformerEncoderVN(Module):
    ...
    def __init__(self, hidden_channels=[256, 64], edge_channels=64, num_edge_types=4, num_interactions=6, cutoff=10.0):
        super().__init__()
    ...
    def forward(self, node_attr, pos, edge_index, edge_feature):
        # edge_index:[2, E] edge_feature:[E, 4] edge_vector:[E, 3]
...
class AttentionInteractionBlockVN(Module):
    ...
    def __init__(self, hidden_channels, edge_channels, num_edge_types, cutoff=10.):
        super().__init__()
        # edge features
